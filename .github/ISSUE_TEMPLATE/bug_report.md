---
name: Bug Report
about: Report a bug or unexpected behavior in BackupForge
labels: bug
---

## BackupForge version (screenshot)

It is displayed in the bottom left corner of the BackupForge UI. Please attach screenshot, not just version text
