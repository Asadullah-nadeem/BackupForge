...
import (
	...
	"BackupForge-verification-agent/internal/features/start"
...
func runStart(args []string) {
	...
	runUpdateCheck(cfg.BackupForgeHost, *isSkipUpdate, isDev, log)
...
func printUsage() {
	fmt.Fprintln(os.Stderr, "Usage: BackupForge-verification-agent <command> [flags]")
