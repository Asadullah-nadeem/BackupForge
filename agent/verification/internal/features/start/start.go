...
import (
	...
	"BackupForge-verification-agent/internal/config"
	"BackupForge-verification-agent/internal/features/api"
	"BackupForge-verification-agent/internal/features/container"
	"BackupForge-verification-agent/internal/features/heartbeat"
	"BackupForge-verification-agent/internal/features/restore"
	"BackupForge-verification-agent/internal/features/runner"
	"BackupForge-verification-agent/internal/features/upgrade"
	"BackupForge-verification-agent/internal/features/verifier"
)
...
func RunDaemon(cfg *config.Config, agentVersion string, isDev bool, log *slog.Logger) error {
	...
	apiClient := api.NewClient(cfg.BackupForgeHost, cfg.Token, cfg.AgentID, log)
