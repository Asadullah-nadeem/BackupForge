# BackupForge — Agent Rules and Guidelines

This document contains project-wide coding standards and best practices for BackupForge.
...
BackupForge handles sensitive data, so security is a layered defence. CodeQL, CodeRabbit, Codex Security, Trivy, Dependabot, gitleaks and semgrep all run on every PR. When working in the repo:
