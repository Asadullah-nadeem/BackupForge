...
export const MainScreenComponent = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<
    'notifiers' | 'storages' | 'databases' | 'profile' | 'BackupForge-settings' | 'users' | 'settings'
  >('databases');
  ...
  // Support Ctrl+R and F5 to reload the page in standalone app mode
  useEffect(() => {
  ...
  // Disable default browser right-click context menu to feel like native desktop app
  useEffect(() => {
  ...
  const tabs = [
    ...
    {
      text: 'BackupForgege settings',
      name: 'BackupForge-settings',
      icon: '/icons/menu/global-settings-gray.svg',
      selectedIcon: '/icons/menu/global-settings-white.svg',
      onClick: () => setSelectedTab('BackupForge-settings'),
      isAdminOnly: true,
      marginTop: '0px',
      isVisible: true,
    },
    ...
    <div style={{ height: screenHeight }} className="bg-[#0f172a] p-2 md:p-3">
      ...
      {isLoading || !user ? (
        ...
        <div className="relative flex">
          ...
          {selectedTab === 'BackupForge-settings' && (
            <div className="flex-1 md:pl-4">
            ...
            <span className="inline-flex items-center gap-1.5">
              ...
              {isNewGitHubVersionAvailable && (
                <Tooltip title="New version available">
                  <a
                    href="https://github.com/BackupForge/BackupForge/releases/latest"
                    target="_blank"
