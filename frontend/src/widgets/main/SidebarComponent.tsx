...
export const SidebarComponent = ({
  ...
  if (!isMobile) {
    return (
      <div
        className="max-w-[60px] min-w-[60px] rounded bg-[#1e293b] py-2 shadow"
  ...
  return (
    ...
    >
      <div className="flex h-full flex-col">
        {/* Custom Close Button */}
        <div className="flex items-center justify-end border-b border-gray-200 px-3 py-3 dark:border-gray-700">
          <button
            onClick={onClose}
