...
export function StarButtonComponent() {
  ...
  const fetchStarCount = async () => {
    try {
      const response = await fetch('https://api.github.com/repos/BackupForge/BackupForge');
      if (response.ok) {
  ...
  return (
    <a
      href="https://github.com/BackupForge/BackupForge"
      target="_blank"
      ...
      aria-label="Star BackupForge/BackupForge on GitHub"
    >
