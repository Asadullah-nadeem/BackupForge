      ...
      <div className="mb-1 flex w-full flex-col items-start sm:flex-row sm:items-center">
        ...
        <div className="flex w-full items-center">
          ...
          <Tooltip
            ...
            title="If backups are encrypted, the files in your storage cannot be used directly. You can restore them through BackupForge or download them unencrypted."
          >
