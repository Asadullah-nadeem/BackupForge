    ...
    <div>
        ...
        <>
          ...
          <div className="mb-1 flex w-full items-center">
            ...
            <div className="flex items-center">
              ...
              <Tooltip
                className="cursor-pointer"
                title="By default BackupForge runs SET SESSION wsrep_on=OFF during restore to avoid Galera writeset-size errors. That requires the SUPER privilege. Enable this to skip it if your managed provider denies SUPER - large restores may then hit Galera writeset limits."
              >
                <InfoCircleOutlined className="ml-2" style={{ color: 'gray' }} />
              </Tooltip>
            </div>
      ...
      {isConnectionFailed && (
        <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">
          If your database uses IP whitelist, make sure BackupForge server IP is added to the allowed
          list.
        </div>
      )}
