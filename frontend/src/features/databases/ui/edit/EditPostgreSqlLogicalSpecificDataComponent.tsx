    ...
    return (
      <>
        ...
        <div className="mb-1 flex w-full items-center">
          ...
          <Input
            type="text"
            style={{ WebkitTextSecurity: 'disc', fontFamily: 'monospace' } as React.CSSProperties}
        ...
        {isConnectionFailed && (
          <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">
            If your database uses IP whitelist, make sure BackupForge server IP is added to the
            allowed list.
          </div>
        )}
      </>
