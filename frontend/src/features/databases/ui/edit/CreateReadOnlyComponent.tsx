...
export const CreateReadOnlyComponent = ({
  ...
  return (
    <div>
      <div className="mb-5">
        <p className="mb-3 text-lg font-bold">Create a {userKindNoun} for BackupForge?</p>
        ...
        <p className="mb-2">
          BackupForge enforce enterprise-grade security (
          <a
            href="https://BackupForge.com/security"
            target="_blank"
            rel="noreferrer"
      ...
      >
        <div className="mb-5">
          ...
          <p className="mb-2">
            ...
            risks. BackupForge is highly recommending you to not skip this step.
          </p>
