  ...
  return (
    <div className="flex grow">
      <div className="w-full">
        ...
        >
          <h1 className="text-2xl font-bold dark:text-white">BackupForge settings</h1>
                  ...
                  <div className="flex items-start justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
                    <div className="flex-1 pr-20">
                      ...
                      <div className="mt-1 text-gray-500 dark:text-gray-400">
                        When enabled, new users can register accounts in BackupForge. If disabled, new
                  ...
                  {!formSettings.isAllowExternalRegistrations && (
                    <div className="flex items-start justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
                      <div className="flex-1 pr-20">
                        ...
                        <div className="mt-1 text-gray-500 dark:text-gray-400">
                          When enabled, existing members can invite new users to join BackupForge. If
          ...
          <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">
            ...
            <a
              href="https://BackupForge.com/access-management#global-settings"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="my-8 max-w-2xl">
            ...
            <div className="group relative">
              ...
              <div className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Use this endpoint to monitor your BackupForge system&apos;s availability
              </div>
            </div>
          </div>
