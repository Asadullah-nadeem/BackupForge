...
const (
	...
	// under "BackupForge_slot_<uuid>" — see model.go's BeforeCreate).
	slotNamePrefix = "BackupForge_basebackup_"
	...
	// configured, unbounded fan-out would saturate BackupForge's connection
