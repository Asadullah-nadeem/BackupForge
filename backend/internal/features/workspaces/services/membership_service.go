...
import (
	...
	users_models "BackupForge-backend/internal/features/users/models"
	users_services "BackupForge-backend/internal/features/users/services"
	workspaces_dto "BackupForge-backend/internal/features/workspaces/dto"
	workspaces_errors "BackupForge-backend/internal/features/workspaces/errors"
	workspaces_interfaces "BackupForge-backend/internal/features/workspaces/interfaces"
	workspaces_models "BackupForge-backend/internal/features/workspaces/models"
	workspaces_repositories "BackupForge-backend/internal/features/workspaces/repositories"
)
...
func (s *MembershipService) buildInvitationEmailHTML(
	...
	if env.BackupForgeURL != "" {
		...
		</p>`, env.BackupForgeURL)
	} else {
		signUpLink = `<p style="margin: 20px 0; color: #666;">
			Please visit your BackupForge instance to sign up and access the workspace.
		</p>`
	}
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
	<div style="background-color: #f8f9fa; border-radius: 8px; padding: 30px; margin: 20px 0;">
		...
		<p style="font-size: 14px; color: #6c757d; margin: 0;">
			This is an automated message from BackupForge. If you didn't expect this invitation, you can safely ignore this email.
		</p>
	</div>
</body>
</html>
